# docker_manager.py - Updated version with path fixes
import subprocess
import time
import os
...
# Add core directory to Python path for import
import sys
...
def start_databases():
    ...
    # Run docker-compose with explicit file path and working directory
    ...
    if result.returncode != 0:
        ...
        print(f"Docker compose file: {docker_compose_path}")
        print(f"File exists: {docker_compose_path.exists()}")
        return False
...
if __name__ == "__main__":
    ...
    if command == "start":
        ...
        print('Valid commands: start, stop, setup, restart')
        sys.exit(1)
